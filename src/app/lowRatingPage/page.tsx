...
interface Logo {
  ...
  const getData = async () => {
    const query = `*[_type == 'negativeProducts'] {
        productTitle,
...
const handleAddressChange = (e: any) => {
    ...
    setAddress(prevAddress => {
        ...
        console.log(updatedAddress); // Log the updated state
    ...
    return (
        <div className={styles.mainWrapper}>
            ...
            <h4 className="text-center">Confirm your shipping address and complete your request</h4>
